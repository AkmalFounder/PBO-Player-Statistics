...
class Player {
    ...
    // set rating 
    public function countRating($rating){
        $this->rating = ($this->avgBallSkill() + $this->avgDefence() + $this->avgGoalKeeper() + $this->avgPassing() + $this->avgPhysical() + $this->avgShooting())/6;
        return $this;
...
echo $didit->avgBallSkill();
echo "<br>";
echo "<br>";
$didit->setCrossing(85);
$didit->setShortPass(81);
$didit->setLongPass(83);
echo $didit->avgPassing();
echo "<br>";
echo "<br>";
$didit->setMarking(77);
$didit->setTackle(79);
echo $didit->avgDefence();
echo "<br>";
echo "<br>";
